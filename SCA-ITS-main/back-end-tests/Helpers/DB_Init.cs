...
public class DB_Init
{
    public static void InitDbForTests(SCA_ITSContext dbContext)
    {
        ...
        List<OtherParent> otherParents = new List<OtherParent>(){
            new OtherParent(){
                Id=1,
                MainParentId=2,
                FirstName="sdfn",
        ...
        dbContext.OtherParents.AddRange(otherParents);
        dbContext.SaveChanges();
        ...
        dbContext.MedicalConditions.AddRange(medicalConditions);
        dbContext.SaveChanges();
        ...
        // create default non sca siblings
        List<NonScaSibling> nonScaSiblings = new List<NonScaSibling>(){
            new NonScaSibling(){
                Id=1,
                StudentNumber="1234",
                Name="ksdnf",
        ...
        dbContext.NonScaSiblings.AddRange(nonScaSiblings);
        dbContext.SaveChanges();

        // create default student other parents
        List<StudentOtherParent> studentOtherParents = new List<StudentOtherParent>(){
            new StudentOtherParent(){
                ParentId=2,
                StudentNumber="220038627"
            },
            new StudentOtherParent(){
        ...
        dbContext.StudentOtherParents.AddRange(studentOtherParents);
        dbContext.SaveChanges();

        // create default student medical conditions
        List<StudentMedicalCondition> studentMedicalConditions = new List<StudentMedicalCondition>(){
            new StudentMedicalCondition(){
                MedicalId=1,
                StudentNumber="220038627"
            },
            new StudentMedicalCondition(){
        ...
        dbContext.StudentMedicalConditions.AddRange(studentMedicalConditions);
        dbContext.SaveChanges();
