...
let UserAccountPage = (props: IProps) => {
    ...
    const validateFile = (): boolean => {
        ...
        if (ext !== "png" && ext !== "jpg" && ext !== "jpeg" && ext !== "webp") {
            errorToast("Only jpg/jpeg or png files excepted", true);
            return false;
        }
    ...
    const updatePassword = async (data: any): Promise<boolean> => {
        ...
        let result: IResponse = await Connection.postRequest(POST_ENDPOINT.USER_EDIT_PASSWORD, {
            userId: props.context.userId,
            ...
            <div className="vert-flex space-evenly hor-center user-component-container">
                <div className="vert-flex user-image">
...

                    {
                        ...
                        <Modal style={{ zIndex: "999999" }} show={editingProfilePic} onHide={() => setEditingProfilePic(false)}>
