        ...
        <div>
            {
                ...
                <AlertComponent title="You have Rejected the info on this page with the following reason: " type="danger" content={props.registrationStatus.detailsRejectionMessage} />
            }
            ...
            <ParentRejectButton context={props.context} editRegistrationStatus={props.editRegistrationStatus} parent={props.parent} type={PARENT_REGISTRATION_STAGE.ADD_DETAILS} />
        </div>
    );
}