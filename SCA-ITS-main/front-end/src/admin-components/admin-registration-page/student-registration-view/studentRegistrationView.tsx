...
export const StudentRegistrationForm = (props: IProps) => {
    ...
    useEffect(() => {
        ...
        if (student && student.registrationStage === STUDENT_REGISTRATION_STAGE.REJECTED)
            setRegistrationStage(student.registrationStage);

        if (student && registrationStage === STUDENT_REGISTRATION_STAGE.REJECTED)
            setRegistrationStage(student.registrationStage);
    }, [student]);
    ...
    return (
        <div className="student-registration-form-container">
...

            {
                ...
                <StudentRegistrationFormNavigationBar context={props.context} refreshStudent={getStudentDetailsLoading} student={student} editRegistrationStatus={editStudentRegistrationStatus} navigateToStage={navigateToStage} registrationStatus={registrationStatus} />
            }
                ...
                <>
                    {
                        ...
                        <StudentBasicInfoForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_GENERAL_INFO)} goToPrevPage={async () => { errorToast("You are at the first stage!") }} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_GENERAL_INFO &&
                        <StudentGeneralInfoForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_RELIGIOUS_INFO)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_BASIC_DETAILS)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_RELIGIOUS_INFO &&
                        <StudentReligiousInfoForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_SCHOLASTIC_INFO)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_GENERAL_INFO)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_SCHOLASTIC_INFO &&
                        <StudentScholasticInfoForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_MEDICAL_DETAILS)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_RELIGIOUS_INFO)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_MEDICAL_DETAILS &&
                        <StudentMedicalInfoForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_MEDICAL_CONDITIONS)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_SCHOLASTIC_INFO)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_MEDICAL_CONDITIONS &&
                        <StudentMedicalConditionsForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_OTHER_PARENTS)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_MEDICAL_DETAILS)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_OTHER_PARENTS &&
                        <StudentOtherParentsForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_NON_SCA_STUDENTS)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_MEDICAL_CONDITIONS)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_NON_SCA_STUDENTS &&
                        <StudentNonScaStudentsForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} goToNextPage={() => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_REQUIRED_DOCS)} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_OTHER_PARENTS)} student={student} />
                    }
                    {
                        registrationStage === STUDENT_REGISTRATION_STAGE.ADD_REQUIRED_DOCS &&
                        <StudentRequiredDocsForm editRegistrationStatus={editStudentRegistrationStatus} context={props.context} registrationStatus={registrationStatus} goToNextPage={() => navigateToStage(registrationStatus.occupationalTherapyNeeded ? STUDENT_REGISTRATION_STAGE.OCCUPATIONAL_THERAPY_NEEDED : (registrationStatus.diagnosticTestNeeded ? STUDENT_REGISTRATION_STAGE.DIAGNOSTIC_TEST_NEEDED : STUDENT_REGISTRATION_STAGE.ADD_REQUIRED_DOCS))} goToPrevPage={async () => navigateToStage(STUDENT_REGISTRATION_STAGE.ADD_NON_SCA_STUDENTS)} student={student} />
                    }
                    {
                    ...
                    }
                    {
                        ...
                        <div className="rounded border shadow m-1">
                            ...
                            <p>This student can now be found in the students section of the admin site.</p>
                        </div>
                    }
                </>
            }
