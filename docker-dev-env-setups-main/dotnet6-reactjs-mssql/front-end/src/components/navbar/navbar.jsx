        ...
        <Navbar className="navbar-custom" variant="" expand="lg" onToggle={setToggled}>
            <Container>
                ...
                <Navbar.Brand style={{ color: "white" }}>
                    ...
                    } alt="An awesome logo" style={{ width: "120px", height: "35px", marginRight: "20px" }} />
                </Navbar.Brand>
                <Navbar.Collapse>
                    <>
                        <Nav>
                            <NavLink to="/" as={Link} style={{ color: "black" }}>Home</NavLink>
                            <NavLink to="/categories" as={Link} style={{ color: "black" }}>Categories</NavLink>
                        </Nav>
                        <Nav>
                            <NavLink to="/items" as={Link} style={{ color: "black" }}>Items</NavLink>
                        </Nav>
                    </>
                </Navbar.Collapse>
