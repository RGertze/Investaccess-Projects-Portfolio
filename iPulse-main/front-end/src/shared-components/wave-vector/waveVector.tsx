...
export const WaveVector = () => {
    ...
    return (
        <GlobalContext.Consumer>
            {context => (
                <div style={{ backgroundColor: context.theme.background }} className="wave-vector-container">
                    <svg viewBox="0 0 1280 111" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0L53 4.17052C107 8.34104 213 16.6821 320 30.7977C427 45.2341 533 65.7659 640 69.9364C747 74.1069 853 61.5954 960 57.7457C1067 53.5751 1173 57.7457 1227 59.6705L1280 61.5954V111H1227C1173 111 1067 111 960 111C853 111 747 111 640 111C533 111 427 111 320 111C213 111 107 111 53 111H0V0Z" fill="#0056FC" fill-opacity="0.8" />
