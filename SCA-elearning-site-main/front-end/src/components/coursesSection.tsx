        ...
        <div id="courses-section-container">
            <Routes>
                <Route path="" element={
                    ...
                    <div>
...

                        {
                            ...
                            <EnrolledCourses token={props.token} username={props.username} viewCourse={viewCourse} />
                        }
...

                        {
                            ...
                            <ResourcesSection token={props.token} />
                        }
...

                {
                    ...
                    <Route path="view" element={<CourseSection course={currentCourse} token={props.token} isStaff={true} username={props.username} />} />
                }
            </Routes>
        </div >
    );
