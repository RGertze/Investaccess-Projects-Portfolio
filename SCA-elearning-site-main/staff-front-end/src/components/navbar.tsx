                ...
                <nav id="nav-container">
                    ...
                    <div id={toggled ? "nav-items-list" : "nav-items-list-untoggled"}>
                        <ul>
                            ...
                            {props.loggedIn &&
                                <React.Fragment>
                                    <li><h4 className="nav-items" onClick={() => { navigate("/staff/home"); setToggled(false); }}>Home</h4></li>
                                    <li><h4 className="nav-items" onClick={() => { navigate("/staff/courses"); setToggled(false); }}>Courses</h4></li>
                                </React.Fragment>
                            }

                            <li><h4 className="nav-items" onClick={() => { navigate("/staff/news"); setToggled(false); }}>News/Events</h4></li>
                            ...
                            <li id="nav-acc">
                                <div id="nav-acc-container">
                                    ...
                                    <div id="nav-acc-dropdown">
                                        {props.loggedIn &&
                                            <React.Fragment>
                                                <h4 className="nav-acc-items" onClick={() => { navigate("/staff/account"); setToggled(false); }}>View Account</h4>
                                        ...
                                        {!props.loggedIn &&
                                            <React.Fragment>
                                                <h4 className="nav-acc-items" onClick={() => { navigate("/staff/"); setToggled(false); }}>Login</h4>
                                            </React.Fragment>
                                        }
                                    </div>
                                </div>
