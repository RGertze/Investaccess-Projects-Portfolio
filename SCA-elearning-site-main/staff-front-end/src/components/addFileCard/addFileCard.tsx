...
class AddFileCard extends Component<IProps, IState> {
...

                    {
                        ...
                        this.props.numberInputs.map(numIn => {
                            return (
                                <div className="form-col add-file-card-str-input">
                                    <h4>{numIn}:</h4>
                                    <input type="number" value={this.state.inputMap.get(numIn)} onChange={ev => {
...

                    {
                        ...
                        this.props.calendarInputs.map(calIn => {
                            return (
                                <div className="form-col add-file-card-str-input">
                                    <h4>{calIn}:</h4>
                                    <input type="date" value={this.state.inputMap.get(calIn)} onChange={ev => {
...

                    {
                        ...
                        this.props.datetimeInputs.map(timeIn => {
                            return (
                                <div className="form-col add-file-card-str-input">
                                    <h4>{timeIn}:</h4>
                                    <input type="datetime-local" value={this.state.inputMap.get(timeIn)} onChange={ev => {
