...
import { IAddDirectMessage, IChatUser, IDirectMessage, IGetAllMessagesBetweenUsers, IGlobalContextState, IMarkMessagesAsRead, IResponse } from "../../interfaces";
...
class ChatMessagingSection extends Component<IProps, IState> {
    ...
    constructor(props: IProps) {
        ...
        this.props.context.wsConn.setChattingWithUser(true);
        this.props.context.wsConn.setAppendMsg(this.appendMsg);
    }
    ...
    markMessagesAsRead = async () => {
        ...
        let data: IMarkMessagesAsRead = {
            toUserID: this.props.userID,
            fromUserID: this.props.userBeingMessaged.userID
        }

        let result: IResponse = await Connection.postReq(POST_TYPE.MARK_MESSAGES_AS_READ, this.props.token, data, {});
